...
for z in range(nl):
 ...
 plt.plot(time/86400,1000.0*np.exp(time/86400)+A_3D[0,z],'--k')
 plt.plot(time/86400,1000.0*np.exp(2*time/86400)+A_3D[0,z],'--k')
 plt.plot(time/86400,1000.0*np.exp(3*time/86400)+A_3D[0,z],'--k')
...
# plt.plot(time/86400,(time/86400+D_3D[0,z])**2,'--k')
# plt.plot(time/86400,(time/86400+D_3D[0,z])**3,'--k')

 p3D, = plt.plot(time/86400,D_3D[:,z],'k',linewidth=2)
 p2D, = plt.plot(time/86400,D_2D[:,z],'b',linewidth=2)
