...
# plot all values
 ...
 pB5 = plt.scatter(np.log10(3*np.sqrt(RD_B[diB:,d])),np.log10(Diff_B[diB:,d]),s=60,color=[0,0,1],marker='o')
 pBW5 = plt.scatter(np.log10(3*np.sqrt(RD_BW[diBW:,d])),np.log10(Diff_BW[diBW:,d]),s=60,color=[1,0,0],marker='o')
