...
path = '/tamay/mensa/fluidity/hycom_summer/'+label+'/'
...
for time in range(dayi,dayf,days):
 ...
 id_y = np.asarray(np.where(y > 31000)) 
...
# p = plt.quiverkey(q,25000,35000,1,"1 m/s",coordinates='data')
 plt.ylabel('Longitude')
 plt.xlabel('Latitude')
 plt.xticks(range(0,35000,5000),(range(0,35,5)))
 plt.yticks(range(0,45000,5000),(range(0,45,5)))
