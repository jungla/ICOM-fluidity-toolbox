...
file1a = 'Wavg_m_25_1b.csv'
filepath1a = path+file1a

file1 = 'Wavg_m_25_1b_particles.csv'
filepath1 = path+file1

file2a = 'Wavg_m_25_2b.csv'
filepath2a = path+file2a

file2 = 'Wavg_m_25_2b_particles.csv'
...
plt.plot([3,3],[0,1.6e-4],'k--')

#plt.ylim([0.0014, 0.00142])
plt.xlim([0, 8])
plt.ylim(0.e-4,1.6e-4)
...
plt.ylabel("$<|w|>$ $[ms^{-1}]$",fontsize=18)
plt.tight_layout()
plt.savefig('./plot/W_t_25.eps')
plt.close()
print 'saved '+'./plot/W_t_25.eps'
