...
Vel1 = stat1["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
Vel1b = stat1b["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
#Vel1c = stat1c["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
Vel2 = stat2["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
Vel2b = stat2b["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
Vel2c = stat2c["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
#Vel2d = stat2d["BoussinesqFluid"]["Temperature_CG"]["l2norm"]
...
V2 = 8000.0*8000.0*50 #168660 #84330 #1280*240  #*8000.0*8000.0*50
...
plt.xlim([0, 14])
plt.xticks(np.linspace(2,9,8),np.linspace(2,9,8).astype(int))
...
plt.tight_layout()
plt.savefig('./plot/T_t.eps')
plt.close()
print 'saved '+'./plot/T_t.eps'
