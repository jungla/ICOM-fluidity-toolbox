...
# print outU, outV
 ...
 plt.legend([pue,pu,perr],['$Ekman$','$BW$','$BW$- $Ekman$'],loc=4,fontsize=20)
 plt.xlabel(r'u $[ms^{-1}]$', fontsize=24)
 plt.ylabel(r'depth $[m]$', fontsize=24)
 plt.xticks(np.linspace(-0.04,0.16,6),np.linspace(-0.04,0.16,6),fontsize=20)
...
plt.ylabel(r'$K_z$ $[m^2\,s^{-1}]$', fontsize=18)
plt.xticks(np.linspace(72,144,5),np.linspace(72,144,5).astype(int),fontsize=16)
